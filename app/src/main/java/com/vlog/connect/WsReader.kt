...
import com.vlog.connect.WsProtocol.B0_FLAG_FIN
import com.vlog.connect.WsProtocol.B0_FLAG_RSV1
import com.vlog.connect.WsProtocol.B0_FLAG_RSV2
import com.vlog.connect.WsProtocol.B0_FLAG_RSV3
import com.vlog.connect.WsProtocol.B0_MASK_OPCODE
import com.vlog.connect.WsProtocol.B1_FLAG_MASK
import com.vlog.connect.WsProtocol.B1_MASK_LENGTH
import com.vlog.connect.WsProtocol.CLOSE_NO_STATUS_CODE
import com.vlog.connect.WsProtocol.OPCODE_BINARY
import com.vlog.connect.WsProtocol.OPCODE_CONTINUATION
import com.vlog.connect.WsProtocol.OPCODE_CONTROL_CLOSE
import com.vlog.connect.WsProtocol.OPCODE_CONTROL_PING
import com.vlog.connect.WsProtocol.OPCODE_CONTROL_PONG
import com.vlog.connect.WsProtocol.OPCODE_FLAG_CONTROL
import com.vlog.connect.WsProtocol.OPCODE_TEXT
import com.vlog.connect.WsProtocol.PAYLOAD_BYTE_MAX
import com.vlog.connect.WsProtocol.PAYLOAD_LONG
import com.vlog.connect.WsProtocol.PAYLOAD_SHORT
