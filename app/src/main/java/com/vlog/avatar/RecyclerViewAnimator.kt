 ...
 */
class RecyclerViewAnimator() : SimpleItemAnimator() {
    ...
    override fun runPendingAnimations() {
        ...
        // First, remove stuff
        for (i in 0 until  mPendingRemovals.size) {
            animateRemoveImpl(mPendingRemovals[i])
        }
    ...
    private fun animateRemoveImpl(holder: RecyclerView.ViewHolder) {
        ...
        Log.d("animation","inter")
        animation.setDuration(removeDuration).translationX(-view.width.toFloat()).setListener(
            object : AnimatorListenerAdapter() {
                ...
                override fun onAnimationPause(animation: Animator?) {
                    ...
                    Log.d("animation","pause")

                }

                override fun onAnimationResume(animation: Animator?) {
                    super.onAnimationResume(animation)
                    Log.d("animation","resume")
                }

                override fun onAnimationEnd(animation: Animator?, isReverse: Boolean) {
                    super.onAnimationEnd(animation, isReverse)
                    Log.d("animation","isReverse:$isReverse")
                }
    ...
    private fun animateAddImpl(holder: RecyclerView.ViewHolder) {
        ...
        animation.translationX(0f).setDuration(addDuration)
